...
const StudentReportBlockSchema = new Schema(
  {
    ...
    source: { type: String, default: "teacher_feedback" },
    additionalNotes: { type: String, default: "" },
    recommendations: { type: String, default: "" },
    manualQuestionsAttempted: { type: String, default: "" },
    manualCorrectAnswers: { type: String, default: "" },
...
const FeesBlockSchema = new Schema(
  {
    ...
    feePlanEmailSentAt: { type: String, default: null },
