...
export function AddAllLeadDialog({
  open,
  onClose,
  onAdded,
  leadSourceOptions = [],
  ...
  return (
    ...
    >
      <div className="border-b border-slate-100 bg-slate-50/80 px-4 py-3">
        <h2 className="text-[15px] font-bold text-slate-900">Add student to All Leads</h2>
        <p className="mt-0.5 text-[12px] text-slate-600">
          Creates a lead in <span className="font-medium">Today&apos;s</span> tab.
          Choose source, then edit in the grid.
        </p>
      </div>
      ...
      <div className="flex flex-wrap justify-end gap-2 border-t border-slate-100 bg-white px-4 py-3">
        ...
        >
          {submitting ? "Saving…" : "Add to All Leads"}
        </button>
      </div>
    </dialog>
  );
